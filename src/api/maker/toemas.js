...
module.exports = function (app) {
    app.get('/v1/maker/toemas', async (req, res) => {
        const { url } = req.query;
        
        // Prompt AI spesialis yang Abang buat tadi (Sangat Bagus!)
        const fixedPrompt = `Anda adalah spesialis kolorimetri digital dan ahli dermatologi visual. Tugas: Analisis foto subjek dan lakukan transformasi warna kulit menjadi gold natural (Gold Skin Tone). Instruksi: Peta Segmentasi Dermas, Penyesuaian Melanin, Rich Umber/Deep Golden, Preservasi Tekstur..`;
