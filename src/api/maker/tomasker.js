...
module.exports = function (app) {
    app.get('/v1/maker/tomasker', async (req, res) => {
        const { url } = req.query;
        
        // Prompt AI spesialis yang Abang buat tadi (Sangat Bagus!)
        const fixedPrompt = `Anda adalah spesialis kolorimetri digital dan ahli dermatologi visual. Tugas: Analisis foto subjek dan lakukan transformasi kepada nya agar menggunakan masker, jangan mengubah foto atau tampilannya.`;
